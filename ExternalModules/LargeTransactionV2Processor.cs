...
public class LargeTransactionV2Processor : IExternalStep
{
    public Dictionary<string, object> Execute(Dictionary<string, object> sharedState)
    {
        ...
        if (accounts == null || accounts.Count == 0 || customers == null || customers.Count == 0)
        {
            ...
            DscWriterUtil.Write("large_transaction_log", false, emptyDf);
        ...
        DscWriterUtil.Write("large_transaction_log", false, df);
