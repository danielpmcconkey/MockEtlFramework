...
public class LoanRiskAssessmentV2Processor : IExternalStep
{
    public Dictionary<string, object> Execute(Dictionary<string, object> sharedState)
    {
        ...
        if (loanAccounts == null || loanAccounts.Count == 0 || creditScores == null || creditScores.Count == 0)
        {
            ...
            DscWriterUtil.Write("loan_risk_assessment", true, emptyDf);
        ...
        {
            avgScoreByCustomer[kvp.Key] = Math.Round(kvp.Value.Average(), 2);
        }
        ...
        DscWriterUtil.Write("loan_risk_assessment", true, df);
